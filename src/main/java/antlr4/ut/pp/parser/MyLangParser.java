...
public class MyLangParser extends Parser {
	...
	public static final int
		...
		T__31=32, BOOL=33, FORK=34, JOIN=35, TID=36, LOCK=37, UNLOCK=38, SHARED=39, 
		IDENTIFIER=40, INT=41, STRING=42, ESCAPE_SEQUENCE=43, COMMENT=44, WS=45;
	public static final int
		...
		RULE_return_statement = 32, RULE_print_statement = 33, RULE_primitive_type = 34, 
	...
	private static String[] makeRuleNames() {
		return new String[] {
			...
			"var_def", "return_statement", "print_statement", "primitive_type", "compound_type", 
			"array", "parameters", "parameter", "args"
		};
	}
	...
	private static String[] makeLiteralNames() {
		return new String[] {
			...
			"'Tid'", "'lock'", "'unlock'", "'shared'", null, null, null, "'\\\"'"
		};
	}
	...
	public final BodyContext body() throws RecognitionException {
		...
		try {
			...
			do {
				...
				_errHandler.sync(this);
				_la = _input.LA(1);
			} while ( (((_la) & ~0x3f) == 0 && ((1L << _la) & 8791588340042L) != 0) );
			}
		}
		catch (RecognitionException re) {
			_localctx.exception = re;
	...
	public final Expression_statementContext expression_statement() throws RecognitionException {
		...
		try {
			...
			_errHandler.sync(this);
			_la = _input.LA(1);
			if ((((_la) & ~0x3f) == 0 && ((1L << _la) & 7791070675264L) != 0)) {
				{
				setState(102);
				expression();
				}
