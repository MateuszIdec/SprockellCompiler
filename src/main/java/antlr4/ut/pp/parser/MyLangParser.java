...
public class MyLangParser extends Parser {
	...
	public static final int
		...
		T__31=32, T__32=33, BOOL=34, FORK=35, JOIN=36, TID=37, LOCK=38, UNLOCK=39, 
		SHARED=40, IDENTIFIER=41, INT=42, STRING=43, ESCAPE_SEQUENCE=44, COMMENT=45, 
		WS=46;
	public static final int
		...
		RULE_definition_statement = 29, RULE_func_def = 30, RULE_var_def = 31, 
		RULE_return_statement = 32, RULE_print_statement = 33, RULE_read_expression = 34, 
		RULE_primitive_type = 35, RULE_compound_type = 36, RULE_array = 37, RULE_parameters = 38, 
		RULE_parameter = 39, RULE_args = 40;
	private static String[] makeRuleNames() {
		return new String[] {
			...
			"join_statement", "lock_statement", "definition_statement", "func_def", 
			"var_def", "return_statement", "print_statement", "read_expression", 
	...
	private static String[] makeLiteralNames() {
		return new String[] {
			...
			"'fn'", "'var'", "'return'", "'print'", "'read'", "','", null, "'fork'", 
	...
	private static String[] makeSymbolicNames() {
		return new String[] {
			...
			null, null, null, null, null, null, null, null, null, null, null, null, 
			null, null, null, null, null, null, null, null, null, null, "BOOL", "FORK", 
			"JOIN", "TID", "LOCK", "UNLOCK", "SHARED", "IDENTIFIER", "INT", "STRING", 
	...
	public final BodyContext body() throws RecognitionException {
		...
		try {
			...
			do {
				...
				_errHandler.sync(this);
				_la = _input.LA(1);
			} while ( (((_la) & ~0x3f) == 0 && ((1L << _la) & 17583386394954L) != 0) );
			}
		}
		catch (RecognitionException re) {
			_localctx.exception = re;
	...
	public final Expression_statementContext expression_statement() throws RecognitionException {
		...
		try {
			...
			_errHandler.sync(this);
			_la = _input.LA(1);
			if ((((_la) & ~0x3f) == 0 && ((1L << _la) & 15586436317504L) != 0)) {
				{
				setState(104);
				expression();
				}
	...
	public final Var_defContext var_def() throws RecognitionException {
		...
		enterRule(_localctx, 62, RULE_var_def);
		int _la;
		try {
			enterOuterAlt(_localctx, 1);
			{
	...
	public final Print_statementContext print_statement() throws RecognitionException {
		...
		enterRule(_localctx, 66, RULE_print_statement);
		try {
			enterOuterAlt(_localctx, 1);
			{
			setState(283);
	...
	public final Read_expressionContext read_expression() throws RecognitionException {
		...
		enterRule(_localctx, 68, RULE_read_expression);
		try {
			enterOuterAlt(_localctx, 1);
			{
			setState(287);
	...
	public final Compound_typeContext compound_type() throws RecognitionException {
		...
		enterRule(_localctx, 72, RULE_compound_type);
		try {
			setState(293);
			_errHandler.sync(this);
			switch (_input.LA(1)) {
