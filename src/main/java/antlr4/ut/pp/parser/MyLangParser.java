...
public class MyLangParser extends Parser {
	...
	public static final int
		...
		UNLOCK=33, SHARED=34, IDENTIFIER=35, INT=36, STRING=37, ESCAPE_SEQUENCE=38, 
		COMMENT=39, WS=40;
	public static final int
		...
		RULE_primitive_type = 30, RULE_compound_type = 31, RULE_array = 32, RULE_args = 33;
	...
	private static String[] makeSymbolicNames() {
		return new String[] {
			...
			"SHARED", "IDENTIFIER", "INT", "STRING", "ESCAPE_SEQUENCE", "COMMENT", 
			"WS"
		};
	}
	...
	public final BodyContext body() throws RecognitionException {
		...
		try {
			...
			do {
				...
				_errHandler.sync(this);
				_la = _input.LA(1);
			} while ( (((_la) & ~0x3f) == 0 && ((1L << _la) & 274730058058L) != 0) );
			}
		}
		catch (RecognitionException re) {
			_localctx.exception = re;
	...
	public final Expression_statementContext expression_statement() throws RecognitionException {
		...
		try {
			...
			_errHandler.sync(this);
			_la = _input.LA(1);
			if ((((_la) & ~0x3f) == 0 && ((1L << _la) & 243538067776L) != 0)) {
				{
				setState(89);
				expression();
				}
