...
public class MyLangParser extends Parser {
	...
	public static final int
		...
		BOOL=25, FORK=26, JOIN=27, TID=28, LOCK=29, UNLOCK=30, SHARED=31, IDENTIFIER=32, 
		INT=33, STRING=34, ESCAPE_SEQUENCE=35, COMMENT=36, WS=37;
	public static final int
	...
	private static String[] makeLiteralNames() {
		return new String[] {
			null, "'{'", "'}'", "';'", "'||'", "'&&'", "'['", "']'", "'('", "')'", 
			"'='", "'=='", "'!='", "'>='", "'<='", "'>'", "'<'", "'+'", "'-'", "'*'", 
			"'while'", "'if'", "'var'", "'print'", "'read'", null, "'fork'", "'join'", 
	...
	private static String[] makeSymbolicNames() {
		return new String[] {
			...
			null, null, null, null, null, null, null, null, null, null, null, null, 
			null, "BOOL", "FORK", "JOIN", "TID", "LOCK", "UNLOCK", "SHARED", "IDENTIFIER", 
			"INT", "STRING", "ESCAPE_SEQUENCE", "COMMENT", "WS"
		};
	}
	...
	public final BodyContext body() throws RecognitionException {
		...
		try {
			...
			do {
				...
				_errHandler.sync(this);
				_la = _input.LA(1);
			} while ( (((_la) & ~0x3f) == 0 && ((1L << _la) & 8203010050L) != 0) );
			}
		}
		catch (RecognitionException re) {
			_localctx.exception = re;
